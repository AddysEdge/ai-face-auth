...
| `tests/` | Python test suite (184 tests): the Phase 1 pipeline, plus the OS-level network check. |
...
suite is 184 tests as of this writing; treat the current count as whatever
