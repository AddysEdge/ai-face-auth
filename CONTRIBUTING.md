...
| `tests/` | Python test suite (234 tests): the Phase 1 pipeline, plus the OS-level network check. |
...
suite is 234 tests as of this writing; treat the current count as whatever
