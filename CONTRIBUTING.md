...
| `tests/` | Python test suite (216 tests): the Phase 1 pipeline, plus the OS-level network check. |
...
suite is 216 tests as of this writing; treat the current count as whatever
